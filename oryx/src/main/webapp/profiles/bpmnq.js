...
e.close();
this.issueQuery(b)
}.bind(this)},{text:"Abort",handler:function(){e.close()
}.bind(this)}]});
...
},processProcessList:function(e){if(e.length==0){Ext.Msg.alert(ORYX.I18N.Oryx.title,"Found no matching processes!");
return
...
}.bind(this),onFailure:function(){Ext.MessageBox.alert(ORYX.I18N.Oryx.title,"Error loading model meta data.")
}.bind(this)})
},_onDblClick:function(a,l,c,m){a.selectRange(l,l);
...
},showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return true
}var a={command:"undef"};
this.createGlobalPresencePattern(a);
b.toggle()
},createGlobalPresencePattern:function(c){try{var a=-30;
var e=this.drawStartEvent(a);
a=a+150;
var d=this.drawActivity(a);
this.drawPath(e,d)
}catch(b){Ext.Msg.alert(ORYX.I18N.Oryx.title,b)
}},drawStartEvent:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
return c
},drawActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
b.toggle()
},createGlobalAbsencePattern:function(c){try{var a=-30;
var e=this.drawStartEvent(a);
a=a+150;
...
this.facade.getCanvas().add(c);
return c
},drawEndEvent:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
},createPrecedencePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
},drawStartActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
this.facade.getCanvas().add(c);
return c
},drawEndActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
},createBeforeAbsencePattern:function(b){var a=-30;
...
},createResponsePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
...
},createAfterAbsencePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
...
},createBetweenAbsenceTypeIPattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
...
},createBetweenAbsenceTypeIIPattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
