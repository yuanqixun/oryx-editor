...
},handleDiagramOnLoad:function(a){this.layoutAllSystems(this.facade.getCanvas())
},layoutAllSystems:function(b){this.layoutAllUseCaseExtended(b);
...
},layoutAllUseCaseExtended:function(a){var b=a.getChildNodes().findAll(function(c){if(this.isUseCaseExtendedNode(c)){return c
}}.bind(this));
b.each(function(c){this.layoutUseCaseExtended(c)
}.bind(this))
},handleUseCaseExtendedLayout:function(b){var a=b.shape;
...
}},handleUseCaseExtendedSelection:function(b){var a=b.elements.first();
...
},layoutUseCaseExtended:function(e){var d=e._svgShapes.find(function(f){return f.element.id==(e.id+"extension_point_text_frame")
}).element;
...
},handlePropertyChanged:function(b){var a=b.elements.first();
if(!this.isSystemNode(a)){return
}if(!(this.isStereotypeKeyEvent(b)||this.isNameKeyEvent(b))){return
}this.layoutStereotype(a)
},layoutStereotype:function(c){var a=c.getLabels().find(function(d){return d.id==(c.id+"stereotype")
});
...
a.update()
},isUseCaseExtendedNode:function(a){return"http://b3mn.org/stencilset/umlusecase#usecaseextended"==a.getStencil().id().toLowerCase()
},isUseCaseNode:function(a){return"http://b3mn.org/stencilset/umlusecase#usecase"==a.getStencil().id().toLowerCase()
},isSystemNode:function(a){return"http://b3mn.org/stencilset/umlusecase#system"==a.getStencil().id().toLowerCase()
},isIncludeEdge:function(a){return"http://b3mn.org/stencilset/umlusecase#include"==a.getStencil().id().toLowerCase()
},isExtendEdge:function(a){return"http://b3mn.org/stencilset/umlusecase#extend"==a.getStencil().id().toLowerCase()
},isStereotypeKeyEvent:function(a){return a.key=="oryx-stereotype"
},isNameKeyEvent:function(a){return a.key=="oryx-name"
}};
