...
this.facade=a;
this.facade.offer({name:ORYX.I18N.VisioImport.BPMNName,functionality:this.importVDX.bind(this),group:"Export",dropDownGroupIcon:ORYX.PATH+"images/import.png",icon:ORYX.PATH+"images/visio_icon.png",description:ORYX.I18N.VisioImport.desc,index:1,minShape:0,maxShape:0})
},importVDX:function(){this._showImportDialog()
},_showImportDialog:function(a){var c=new Ext.form.FormPanel({defaultType:"textfield",layout:"anchor",border:false,fileUpload:true,reader:{read:function(d){return d.responseText.replace(/\s*<(pre|\/pre)>\s*/gi,"")
}},items:[{text:ORYX.I18N.VisioImport.PleaseSelect,style:"font-size:12px;margin-bottom:10px;display:block;",xtype:"label"},{name:"vdxFile",inputType:"file",style:"margin-bottom:10px;display:block;",itemCls:"ext_specific_window_overflow"},{name:"stencil",inputType:"hidden",value:"bpmn"}]});
...
}.bind(this),failure:function(d,e){b.close();
...
}}.bind(this)},{text:Ext.MessageBox.buttonText.cancel,handler:function(){b.close()
}.bind(this)}]});
b.show()
}});
if(!ORYX.Plugins){ORYX.Plugins=new Object()
