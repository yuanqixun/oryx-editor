...
},setStencilSets:function(){var c=this.shapeList.firstChild;
...
}},createStencilTreeNode:function(a,b){var d=new Ext.tree.TreeNode({text:"Task",icon:ORYX.PATH+"/stencilsets/bpmn2.0/icons/activity/task.png",allowDrag:false,allowDrop:false,iconCls:"ShapeRepEntreeImg",cls:"ShapeRepEntree"});
a.appendChild(d);
d.render();
var c=d.getUI();
...
},drop:function(b,g,f){this._lastOverElement=undefined;
