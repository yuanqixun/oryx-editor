...
},sendToBack:function sendToBack(b){var a=b.shape;
a.node.parentNode.insertBefore(a.node,a.node.parentNode.firstChild)
},centerOnLifeline:function centerOnLifeline(c){var a=c.shape;
var b=a.getParentShape();
var d=b.absoluteCenterXY().x-a.absoluteCenterXY().x;
a.bounds.moveBy(d,0)
},centerTerminatorOnLifeline:function centerTerminatorOnLifeline(e){var b=e.shape;
